$(document).ready(function() {
    ...
    // Listen for click on the toggleReviews span
    $('#toggleReviews').click(function() {
        if (reviewsVisible) {
        // If reviews are visible, hide them and change the button text to "show"
            $('#reviewsList').empty();
            $(this).text('show');
	} else {
	     // If reviews are hidden, fetch, parse, and display reviews, change the button text to "hide"
        ...
        // Toggle the reviewsVisible variable
